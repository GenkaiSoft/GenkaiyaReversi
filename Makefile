bin/NT/reversi.exe: bin/NT/resource.o bin/NT/window.o bin/NT/board.o
	x86_64-w64-mingw32-g++ bin/NT/window.o bin/NT/board.o bin/NT/resource.o -s -O3 -o bin/NT/reversi.exe -mwindows
...
bin/CE/AppMain.exe: bin/CE/resource.o bin/CE/window.o bin/CE/board.o
	arm-mingw32ce-g++ bin/CE/window.o bin/CE/board.o bin/CE/resource.o -s -O3 -march=armv5tej -mcpu=arm926ej-s -o bin/CE/AppMain.exe -lcommctrl
